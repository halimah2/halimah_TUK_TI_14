<div class="content-wrapper"> 
	...
	<input type="text"name="judul" class="form-control" placeholder="Masukkan judul halaman.." value="
	...
	<?php echo form_error('konten'); ?> 
		<br/> 
			<textarea class="for-control" id="editor" name="konten"> <?php echo set_value('konten'); ?> </textarea> 
				</div> 
					</div> 
