...
{ 
	...
	{ 
		...
		if($this-> form_validation->run() != false){ 
			...
			$data = array('halaman_judul' => $judul,'halaman_slug' => $slug,'halaman_konten' => $konten); 
	...
	public function kategori_aksi()
	{
		...
		if($this-> form_validation->run() != false){
			$kategori = $this-> input->post('kategori');
			$data = array('kategori_nama' => $kategori,'kategori_slug' => strtolower(url_title($kategori)));
	...
	public function profil_update()
	{
		...
		if($this-> form_validation->run() != false){
			...
			$data = array('pengguna_nama' => $nama,'pengguna_email' => $email);
			$this-> m_data->update_data($where,$data,'pengguna');
